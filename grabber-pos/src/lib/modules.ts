...
export const MODULE_GROUPS: ModuleGroup[] = [
  {
    ...
    tiles: [
      ...
      { key: "rooms", title: "Rooms", subtitle: "Hotel booking", icon: "🏨", href: "/rooms", status: "active" },
      { key: "rent", title: "Rent", subtitle: "Rentals + deposits", icon: "🔑", href: "/rent", status: "active" },
      { key: "hire", title: "Hire purchase", subtitle: "Installments", icon: "📆", href: "/hire-purchase", status: "active" },
  ...
  },
  {
    ...
    tiles: [
      ...
      { key: "cashin", title: "Cash in", subtitle: "Into the drawer", icon: "📥", href: "/cashin", status: "active" },
      { key: "cashout", title: "Cash out", subtitle: "Out of the drawer", icon: "📤", href: "/cashout", status: "active" },
      ...
      { key: "addjobs", title: "Jobs", subtitle: "Assign employee jobs", icon: "🧰", href: "/jobs", status: "active" },
    ],
  },
  {
    label: "Sales & comms",
  ...
  },
  {
    ...
    tiles: [
      ...
      { key: "updates", title: "Updates & help", subtitle: "Notes & videos", icon: "📣", href: "/updates", status: "active" },
    ],
  },
  {
    label: "Reselling",
